...
| `auto_object_proposals` | Mock only today | Future backend dependent | Yes for real backend | No | Default clean candidate gallery before selected-object tracking. | Clean misses small objects; recall/Trace Everything can be noisy and review-heavy. |
