...
| `sam3-local` / `sam3-hosted` | Optional | Concept, exemplar, and higher-recall discovery | Mock modes are no-model; real local SAM3 uses the optional adapter only when Python/CUDA/model diagnostics pass. |
