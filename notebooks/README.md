...
| `colab_sam_remote_api.ipynb` | [![Open in Google Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ptse8204/json-animated-video/blob/main/notebooks/colab_sam_remote_api.ipynb) | Starts an authenticated temporary SAM2/SAM3 JSON API in Colab for the Local UI to call through a tunnel. | Full UI testing with Provider Settings -> Colab SAM runtime after explicit hosted opt-in. |
