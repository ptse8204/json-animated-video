...
def add_extract_args(p: argparse.ArgumentParser) -> None:
    ...
    p.add_argument("--sam2-checkpoint", type=str, default=None, help="SAM2 checkpoint path for --mask-provider sam2-local")
    p.add_argument("--sam2-config", "--sam2-model-config", dest="sam2_model_config", type=str, default=None, help="SAM2 model config for --mask-provider sam2-local")
    p.add_argument("--sam2-device", type=str, default=None, help="SAM2 runtime device, e.g. cpu, cuda, mps")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    backend = sub.add_parser("backend", help="Run backend workspace commands")
    ...
    ui.add_argument("--port", type=int, default=8766, help="Port for the workspace server; use 0 to choose a free port")
