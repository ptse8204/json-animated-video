...
PROVIDER_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "customModelAllowed": True,
        "capabilities": ["scene sweep via HF tracker", "SAM3 Tracker video"],
        "supportedGoals": ["trace_all_objects"],
        "supportedPromptTypes": [],
        "supportsConcept": False,
        "supportsExemplar": False,
        ...
        "warning": "SAM3 Scene Sweep is for scene-wide proposals. Text prompts need Hosted SAM3 text discovery or the advanced local SAM3 concept/exemplar path.",
        "setupGuide": {
            "recommendedFor": "Best runtime path for scene-wide discovery and SAM3 Tracker video propagation.",
            "setupSummary": "Install the sam3-transformers extra, paste a Hugging Face token if facebook/sam3 is gated, cache facebook/sam3 from the UI, then run a smoke proof.",
            "commands": [
                "pip install 'motionjson[sam3-transformers]'",
                "pip install torch torchvision --index-url https://download.pytorch.org/whl/cu128",
                "hf auth login",
                "python -c \"from transformers import Sam3TrackerModel, Sam3Processor; Sam3TrackerModel.from_pretrained('facebook/sam3'); Sam3Processor.from_pretrained('facebook/sam3')\"",
            ],
        },
